// Created by Metaio_Creator_6.0.1_MACOS_2014-12-09T12:39:42
...
arel.sceneReady(function() {
    ...
    scenario.currentTrackingConfigPathOrIdentifier = "html/resources/TrackingConfig_cdc6185f07e6f7076f6e8dd3768b5914.zip";
    ...
    scenario.onStartup = function () {
        arel.Debug.log("Welcome to the 'video.gundam' Augmented Reality experience.");
    ...
    image2.type = "Image";
    image2.scene = scene1;
    image2.associatedTrackable = pattern1;
    ...
    image2.play = function (animationName, animationLooped) {
        arel.Debug.log(this.objectName + ".play(" + animationName + ", " + animationLooped + ")");
        this.startAnimation(animationName, animationLooped);
        if (methodExists(this, this.onPlayed)) {
            this.onPlayed(animationName);
    ...
    image2.onLoaded = function () {
        ...
        image2.setTransparency(1);
        
        /***** End of custom script *****/
    };


    // Screen Shot 2015-04-07 at 5.03.38 PM
    ...
    image4.type = "Image";
    image4.scene = scene1;
    image4.associatedTrackable = pattern1;
    ...
    image4.onTouchEnded = function () {
        arel.Debug.log(this.objectName + ".onTouchEnded()");
        /**** Begin of custom script ****/
        
        	video1.setTransparency(0);
            video1.play();
        	image1.setTransparency(0);
        	image2.setTransparency(0);
        	model1.startAnimation("rise", false);
         image2.startAnimation("rotate3", true);
        	image4.setTransparency(1);
    ...
    // Gundam Extreme Vs - Crossbone Gundam Montage
    ...
    video1.play = function () {
        ...
        if (scenario.googleAnalytics) {
            scenario.googleAnalytics.logVideo("Gundam Extreme Vs - Crossbone Gundam Montage");
        }
        if (methodExists(this, this.onPlayed)) {
            this.onPlayed();
        }
    ...
    video1.onTouchStarted = function () {
